...
| Gate Epic 1 | `Blocked` | Epic 0 encore en cours ; Story 0.2 cloturee ; Story 0.3 preparee localement (`steam_appid.txt`, helper smoke test Steamworks, transport Facepunch verifie) avec preuve VAL-012 fournie ; VAL-013 a VAL-015 restent en cours ; Stories 0.4 a 0.8 encore ouvertes | Epic 1 reste bloquee tant que l'Epic 0 n'est pas marquee `Pass` ou explicitement acceptee avec bloqueurs documentes. |
